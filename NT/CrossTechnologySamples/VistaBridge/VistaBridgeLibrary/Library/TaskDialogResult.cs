...
namespace Microsoft.SDK.Samples.VistaBridge.Library
{
    ...
    public class TaskDialogResult
    {
        ...
        /// </summary>
        /// <remarks>
        /// TaskDialogStandardButton.None will be returned if some other option was selected, or the
        ...
        /// <summary>
        /// Indicates which named custom button was selected by the user. It will be null
        ...
        /// <summary>
        /// Indicates which radio button was selected when the user closed the dialog. It will be null

namespace AdaptiveTopologySample
{
    ...
    /// <summary>
    /// Interaction logic for TaskPage3.xaml
    /// </summary>

    public partial class TaskPage3 : PageFunction<TaskResult>
    {
        public TaskPage3(object taskData)
        {
            InitializeComponent();
            ...
            this.Loaded += new RoutedEventHandler(TaskPage3_Loaded);
        }

        void TaskPage3_Loaded(object sender, RoutedEventArgs e)
        {

...
Namespace SDKSample
    ...
    Partial Public Class Window1
        ...
        End Sub
        Public Sub ChangeRight(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
        ...
        End Sub
        Public Sub ChangeTop(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
        ...
        End Sub
        Public Sub ChangeBottom(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)

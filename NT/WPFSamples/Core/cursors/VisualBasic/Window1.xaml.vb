...
Namespace SDKSamples
    Partial Public Class Window1
        ...
        Sub CursorTypeChanged(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
        ...
        '
        Sub CursorScopeSelected(ByVal sender As Object, ByVal e As RoutedEventArgs)

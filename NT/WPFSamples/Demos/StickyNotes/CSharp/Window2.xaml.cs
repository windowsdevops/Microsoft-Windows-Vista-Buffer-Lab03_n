...
namespace StickyNotes
{
    public class Window2 : Window
    {
        ...
        private StackPanel InitializeStickyNote()
        {
            ...
            menuButton.Background = Brushes.Red;
            ...
            m0.BorderThickness = new Thickness(1);
                ...
                m1.Background = Brushes.BlanchedAlmond;
                m1.Header = "Minimize";
                m1.Click += new RoutedEventHandler(m1_Click);

                MenuItem m2 = new MenuItem();
                m2.Background = Brushes.BlanchedAlmond;
                ...
                m7.Background = Brushes.BlanchedAlmond;
        ...
        void dialog_Closed(object sender, EventArgs e)
        {
            ...
            if (dia.Tag != null)
            {
                ...
                if (arr[2] != null)
                {
                    ...
                    Image m2 = LogicalTreeHelper.FindLogicalNode(w, "AlarmIndicator") as Image;

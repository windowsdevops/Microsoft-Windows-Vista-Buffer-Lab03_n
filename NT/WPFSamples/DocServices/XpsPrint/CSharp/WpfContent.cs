...
namespace SDKSampleHelper
{
    ...
    internal class WPFContent
    {
        ...
        {
            string fullPath = _contentDir + "\\" + _existingContainer;
        ...
        private PageContent CreateFourthPageContent(PrintQueue pq)
        {
            ...
            BitmapImage bitmapImage = new BitmapImage(
                new Uri(_contentDir + "/" + _thirdImage,
        ...
        private readonly String _thirdImage = @"Content\tiger.jpg";

        private          String _contentDir;

        private const    String _existingContainer =

...
namespace SDKSample
{
    ...
    {
		// Ambient light value.
        AmbientLight _ambLight = new AmbientLight(Brushes.DarkBlue.Color);
        ...
        private Color[] _dirLightColor = new Color[nbrDirLights] { Brushes.White.Color, Brushes.Yellow.Color };

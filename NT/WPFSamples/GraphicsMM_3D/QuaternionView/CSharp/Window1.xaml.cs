...
namespace QuaternionView
{
    ...
    public partial class Window1 : Window
    {
        ...
        public void UpdateWXYZSettings(object sender, EventArgs e)
        {
            //Clear prior values
        ...
        public void UpdateParseXYZWSettings(object sender, EventArgs e)
        {
            //Clear prior values
            myprocTransformGroup.Children.Clear();
            XAxisValue.Clear();
        ...
        public void UpdateAxisAngleSettings(object sender, EventArgs e)
        {
            //Clear prior values
            myprocTransformGroup.Children.Clear();
            WValue.Clear();

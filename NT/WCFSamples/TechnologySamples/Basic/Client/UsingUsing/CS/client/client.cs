...
namespace Microsoft.ServiceModel.Samples
{
    ...
    class Client
    {
        ...
        // happens, the client gets an Exception from Close.  Since Dispose is the same as
        ...
        // having to write try/catch/finally code.  However, since the closing brace can throw,
        ...
        static void DemonstrateProblemUsingCanThrow()
        {
            ...
            catch (CommunicationException e)
            {
                ...
                // want to use using, you need to surround it with a try/catch
        ...
        // happens, the client gets an Exception from Close.  Since Dispose is the same as
        // Close, the client gets an Exception from Dispose as well.  The close of the "using"
        // block results in a call to client.Dispose.  Since the closing brace executes
        // regardless of whether an Exception occured, Exceptions from Close can mask more
        ...
        static void DemonstrateCleanupWithExceptions()
        {
            ...
            try
            {
                ...
                // Do a clean shutdown if everything works.  In this sample we don't end up
            ...
            {
                // In this sample we don't end up here, but correct code should catch
            ...
            {
                // In this sample we don't end up here.  It is best practice to clean up the

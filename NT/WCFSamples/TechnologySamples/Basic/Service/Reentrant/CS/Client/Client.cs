...
{
    /**
     * The callback implementation will call back to the service and so this also needs
     * to be marked Reentrant
     */ 
    ...
    public class PingPongCallback : IPingPongCallback
    {
        ...
        public void Pong(int ticks)
        {
            ...
            if (ticks != 0)
            {
                ...
                //orignal message) and make an outgoing call till ticks reaches 0.

...
Sub DoSleepCycle(ConsoleAction, SleepState)
    ...
    Console.ResetDisplayIdleTimer
    Console.ResetSystemIdleTimer
End Sub
...
Sub DoDisableEnableCycle(Devices)
    ...
    For Each Device In Devices
        ...
        On Error Resume Next
        Set Action = Device.GetInterface("Action\DisEn")
        ...
        If Err.number = 0 Then
            ...
            On Error Goto 0
        Else
            L.Trace LVL_MSG, hLog, "Action\DisEn implementation not found! " & Err.Description
        End If

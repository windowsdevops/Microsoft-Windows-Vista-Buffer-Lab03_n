...
#ifndef __IMTest_FWD_DEFINED__
#define __IMTest_FWD_DEFINED__
typedef interface IMTest IMTest;
#endif 	/* __IMTest_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IBogusUnreferenced_WDTFInterfaces;
    ...
    typedef struct IBogusUnreferenced_WDTFInterfacesVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IBogusUnreferenced_WDTFInterfaces * This,
...
enum __MIDL___MIDL_itf_WDTFInterfaces_0001_0064_0001
    {	SimpleIO_Stopped	= 0,
...
#ifndef __IMTest_INTERFACE_DEFINED__
#define __IMTest_INTERFACE_DEFINED__

/* interface IMTest */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IMTest;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("C890B8C6-6265-4BD8-B5C0-FF813DADEB75")
    IMTest : public IWDTFBase
    {
    public:
    };
    ...
    interface IMTest
    {
        CONST_VTBL struct IMTestVtbl *lpVtbl;
    };
...
#define IMTest_QueryInterface(This,riid,ppvObj,retval)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObj,retval) ) 

#define IMTest_AddRef(This,retval)	\
    ( (This)->lpVtbl -> AddRef(This,retval) ) 

#define IMTest_Release(This,retval)	\
    ( (This)->lpVtbl -> Release(This,retval) ) 

#define IMTest_GetTypeInfoCount(This,pctinfo,retval)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo,retval) ) 

#define IMTest_GetTypeInfo(This,itinfo,lcid,pptinfo,retval)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,itinfo,lcid,pptinfo,retval) ) 

#define IMTest_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgdispid,retval)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgdispid,retval) ) 

#define IMTest_Invoke(This,dispidMember,riid,lcid,wFlags,pdispparams,pvarResult,pexcepinfo,puArgErr,retval)	\
    ( (This)->lpVtbl -> Invoke(This,dispidMember,riid,lcid,wFlags,pdispparams,pvarResult,pexcepinfo,puArgErr,retval) ) 

#define IMTest_SetTraceLevel(This,Level,retval)	\
    ( (This)->lpVtbl -> SetTraceLevel(This,Level,retval) ) 

#define IMTest_SetTarget(This,pMainTarget,MoreTargets,retval)	\
...
#endif 	/* __IMTest_INTERFACE_DEFINED__ */

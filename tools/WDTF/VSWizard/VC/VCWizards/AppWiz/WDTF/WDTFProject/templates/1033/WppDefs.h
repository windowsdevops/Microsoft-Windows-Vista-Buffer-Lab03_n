...
//FUNC COMReportError{COMRETURNLEVEL=COMEntryExit}(COMPNAME, HR, ERRMSG);
//end_wpp
//#define WPP_COMRETURNLEVEL_PRE(LEVEL)
#define WPP_COMRETURNLEVEL_COMPNAME_HR_ERRMSG_ENABLED(LEVEL, comp, HR, errmsg) IS_LEVEL_ENABLED(comp##LEVEL)
#define WPP_COMRETURNLEVEL_COMPNAME_HR_ERRMSG_LOGGER(LEVEL, comp, HR, errmsg) WPP_LEVEL_LOGGER(comp##LEVEL)
#define WPP_COMRETURNLEVEL_COMPNAME_HR_ERRMSG_PRE(LEVEL, comp, HR, errmsg)  { \
                                                                                HRESULT __hResult = HR; \
...
#define WPP_COMRETURNLEVEL_COMPNAME_HR_ERRMSG_POST(LEVEL, comp, HR, errmsg)     /*TraceMessage()*/; \

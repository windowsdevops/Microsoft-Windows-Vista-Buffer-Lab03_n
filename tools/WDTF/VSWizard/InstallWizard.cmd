...
//
// Pre-conditions:
//   You must have Visual C++ 2005 installed.
//
//
...
// Find where Visual C++ 2005 is installed
try
{
    strVCPath = oShell.RegRead("HKLM\\SOFTWARE\\Microsoft\\VisualStudio\\SxS\\VC7\\8.0");
}
catch(e)
{
    oShell.Popup("Visual C++ 2005 does not appear to be installed, please install it before running this installer.",
...
try
{
    strVCPath = oShell.RegRead("HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\VisualStudio\\SxS\\VC7\\8.0");
}
catch(e)
{

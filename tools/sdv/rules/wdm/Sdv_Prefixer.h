...
/* This file is a subset of the files: sdv_wdm.h, sdv_ntddk.h,
   sdv_ntifs.h and sdv_wdmsec.h.  It is used when we compile the slic
   rules, so that no matter whether they are stated in term of
   function foo or function sdv_foo, they will work correctly.
*/

...
#pragma alloc_text(PAGESRP0, SerialEvtDeviceD0EntryPostInterruptsEnabled)
...

{
    ...
    //
    if (IoIsWdmVersionAvailable(1, 0x30) == FALSE) {
    ...
    // request is currently active. If so then it will forward it to another manual queue.

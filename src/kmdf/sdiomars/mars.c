...
#include "mars.h"
    ...
    #pragma alloc_text (PAGE, MarsEvtDevicePrepareHardware)
    #pragma alloc_text (PAGE, MarsEvtDeviceReleaseHardware)
    #pragma alloc_text (PAGE, MarsEvtIoDeviceControl)
    #pragma alloc_text (PAGE, MarsEvtIoRead)
    #pragma alloc_text (PAGE, MarsEvtIoWrite)
    #pragma alloc_text (PAGE, SdioReadWriteBuffer)
    #pragma alloc_text (PAGE, SdioReadWriteByte)
    #pragma alloc_text (PAGE, SdioGetProperty)
    #pragma alloc_text (PAGE, SdioGetProperty)
#endif
...
--*/
{
    ...
    interfaceParameters.DeviceGeneratesInterrupts   = FALSE;    //change to true eventually
...
--*/
{
    ...
    status = SdioReadWriteBuffer(device,
                                 ...
                                 parameters.Parameters.Read.Length,
                                 FALSE,
                                 &bytesRead);

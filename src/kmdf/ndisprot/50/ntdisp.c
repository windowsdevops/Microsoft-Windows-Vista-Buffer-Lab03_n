...
#pragma alloc_text(PAGE, NdisProtEvtDriverUnload)
#pragma alloc_text(PAGE, NdisProtEvtDeviceFileCreate)
#pragma alloc_text(PAGE, NdisProtEvtFileClose)
...
--*/
{
    ...
    //
    // All the other resources such as control-device, symbolic link, queue associated
    // with the device will be automatically deleted by the framework.
    //

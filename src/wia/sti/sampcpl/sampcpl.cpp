        ...
        case WM_INITDIALOG:
            {
                ...
                *szPath = TEXT('\0');
                ...
                WideCharToMultiByte(CP_ACP, 0,
                                    ...
                                    NULL,NULL);
#else
                StringCchCopy(szPath,ARRAYSIZE(szPath),psdi->pszPortName);
#endif
        ...
        case WM_NOTIFY:
            {
                ...
                if ( lpnmh -> code == PSN_APPLY ) {
                    ...
                    psdi = (PSTI_DEVICE_INFORMATION)GetWindowLongPtr(hwnd, DWLP_USER);
                    ...
                    if (psdi && g_pSti) {
                        ...
                        GetWindowText(GetDlgItem(hwnd,IDC_EDIT_PATH),szPath,ARRAYSIZE(szPath));
                        ...
                        if (*szPath) {
                            ...
                            MultiByteToWideChar(CP_ACP, 0,
                                                szPath,-1,
                                                wszPath,ARRAYSIZE(wszPath));
#else
                            StringCchCopy(wszPath,ARRAYSIZE(wszPath),szPath);
#endif

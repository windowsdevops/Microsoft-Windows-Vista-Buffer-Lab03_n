...
{
    IWiaPropertyStorage  *pWiaStorage = NULL;
 ...
 * 
 *****************************************************************************/
HRESULT CWiaItem::ReadRequiredPropertyLong(PROPID PropertyID, LONG *plPropertyValue)
{
    if (!plPropertyValue)
    {
        return E_INVALIDARG;
...
HRESULT CWiaItem::ReadRequiredPropertyBSTR(PROPID PropertyID, BSTR *pbstrPropertyValue)
{
...
HRESULT CWiaItem::ReadRequiredPropertyGUID(PROPID PropertyID, GUID *pguidPropertyValue)
{

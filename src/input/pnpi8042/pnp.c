...
#pragma prefast(suppress: 28159, "Use of IoQueryDeviceDescription is necessary in this context")
...
--*/
{
    ...
    if(item){
       RtlZeroMemory(item, sizeof(POWER_UP_WORK_ITEM));

        //
        // Allocate our work item
        //

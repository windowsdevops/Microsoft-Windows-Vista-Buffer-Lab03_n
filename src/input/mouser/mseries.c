...
//  $IPCategory:     
//  $DealPointID:    150479
//  $AgreementName:  device code license agreement
//  $AgreementType:  inbound license
//  $ExternalOrigin: logitech
//$ENDTAG

//$TAG ENGR 
//  $Owner:    randyau
//  $Module:   drivers_input_mouser
//
//$ENDTAG
...
--*/
{
    ...
    if(NewProtocol >= MSER_PROTOCOL_MAX){
        //
        // If it is an invalid protocol index,
        // we default to know protocol (in this case Microsoft Plus)
        //
        NewProtocol = MSER_PROTOCOL_MP;
    }

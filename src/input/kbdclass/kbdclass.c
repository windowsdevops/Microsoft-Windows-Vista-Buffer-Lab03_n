...
#pragma alloc_text(PAGE,KbdEnableDisablePort)
#endif
    ...
    if (DeviceExtension->InputCount == 0) {
        ...
        if (Irp->Cancel) {
            ...
            if (oldCancelRoutine) {
                ...
                KbdPrint((
                    0,
                    "KBDCLASS: Irp was cancelled, cancel Routine was NOT called"
                    ));
                ...
                KbdPrint((
                    0,
                    "KBDCLASS: Irp was cancelled, cancel Routine was called"
                    ));
            }
        }
...
KeyboardClassCreateWaitWakeIrpWorker (
    __in PDEVICE_OBJECT DeviceObject,
    __in PKEYBOARD_WORK_ITEM_DATA  ItemData
    )
{
    PAGED_CODE ();

...
FacilityNames=(System=0x0
               ...
               Video=0x1B:FACILITY_VIDEO_ERROR_CODE
              )
...
MessageId=0x0004 Facility=Video Severity=Error SymbolicName=VID_MISMATCH
Language=English
You are running different builds of the miniport and display driver.
Please use a matched pair.
.

MessageId=0x0005 Facility=Video Severity=Warning SymbolicName=VID_OBSOLETE
Language=English
You are using an unrecognized (designed after this version of the driver
was built) ATI accelerator. Please install an updated driver.
.

MessageId=0x0006 Facility=Video Severity=Warning SymbolicName=VID_LFB_CONFLICT
Language=English
LFB Aperture conflict, disabling aperture.
.

MessageId=0x0007 Facility=Video Severity=Informational SymbolicName=VID_ATIOEM_UNUSED
Language=English

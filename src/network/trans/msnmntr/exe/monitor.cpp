...
#define MSN_MESSENGER_FILE_PATH L"%ProgramFiles%\\MSN Messenger\\msnmsgr.exe"
#define MSN_MESSENGER_FILE_PATH_WOW64 L"%ProgramFiles(x86)%\\MSN Messenger\\msnmsgr.exe"
...
--*/
{
   ...
   printf("Opening Firewall Engine\n");
   ...
   printf("Adding Persistent Flow Established callout through the Firewall Engine\n");
   ...
   printf("Adding Persistent Stream callout through the Firewall Engine\n");
...
--*/
{
   ...
   HANDLE engineHandle = NULL;
   FWPM_SESSION0 session;
   BOOLEAN addedFlowCallout = FALSE;
   BOOLEAN addedStreamCallout = FALSE;
   ...
   result = FwpmCalloutDeleteByKey0(engineHandle,
...
--*/
{
   ...
   FWPM_FILTER0 filter;
   FWPM_FILTER_CONDITION0 filterConditions[2]; // We only need two for this call.
    ...
    __out FWP_BYTE_BLOB** appId)
{
   ...
   result = FwpmGetAppIdFromFileName0(fileName, appId);
...
MonitorAppDoMonitoring()
{
   ...
   printf("Successfully opened Firewall Engine\n");
   ...
   printf("Adding Filters through the Firewall Engine\n");
   ...
   printf("Successfully added Filters through the Firewall Engine\n");

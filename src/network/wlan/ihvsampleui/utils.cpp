...
)
{
    ...
    if ( SecurityType >= IHVSecurityInvalid )
    {
        hr = E_UNEXPECTED;
        BAIL_ON_FAILURE( hr );
    }
...
)
{
    ...
    if ( CipherType >= IHVCipherInvalid )
    {
        hr = E_UNEXPECTED;
        BAIL_ON_FAILURE( hr );
    }

...
#define IHV_DEFAULT_TITLE     L"IHV Properties"
#define IHV_DEFAULT_CON_TITLE L"IHV Connection Properties"
#define IHV_DEFAULT_KEY_TITLE L"IHV Security Properties"
#define IHV_DEFAULT_SEC_TITLE L"IHV Security Properties"

...
static const NDIS_GUID NICGuidList[NIC_NUM_CUSTOM_GUIDS] = {
    { // {F4A80276-23B7-11d1-9ED9-00A0C9010057} example of a uint set
        ...
        sizeof(ULONG),
        //
        // NDIS 6.0 and later driver must specify the security descriptors for their private GUIDs
        // in the INF files. NDIS doesn't check fNDIS_GUID_ALLOW_WRITE or fNDIS_GUID_ALLOW_READ 
        // any more
        //
        (fNDIS_GUID_TO_OID)
    },

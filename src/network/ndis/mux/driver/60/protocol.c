...
--*/
{
    ...
    do
    {
        pMuxNdisRequest = NdisAllocateMemoryWithTagPriority(pAdapt, sizeof(MUX_NDIS_REQUEST), MUX_TAG, LowPoolPriority);
...
--*/
{
    ...
    do
    {
        ...
        //
        PtReferenceVElan(pVElan, "CreatVelan");
        ...
        if (Status != NDIS_STATUS_SUCCESS)
        {
            ...
            PtDereferenceVElan(pVElan, "CreatVelan");
            pVElan = NULL;
            break;
        }
...
--*/
{
    ...
    do
    {
        ...
        //
        pVElan = NdisAllocateMemoryWithTagPriority(pAdapt, Length, MUX_TAG, LowPoolPriority);
        if (pVElan == NULL)
        {
...
--*/
{
    ...
    do
    {
        ...
        //
        VElanKeyName.Buffer = NdisAllocateMemoryWithTagPriority(pAdapt, 
...
--*/
{
    ...
    while (NetBufferLists != NULL)
    {
        ...
        do
        {
            ...
            {
                //
                // If the VLAN info is already in the NBL, ignore it
                //            

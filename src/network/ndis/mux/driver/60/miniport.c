...
--*/
{
    ...
    do
    {
        ...
        GeneralAttributes.MediaType = VELAN_MEDIA_TYPE;
        GeneralAttributes.MtuSize = pVElan->pAdapt->BindParameters.MtuSize;
        GeneralAttributes.MaxXmitLinkSpeed = pVElan->pAdapt->BindParameters.MaxXmitLinkSpeed;
        GeneralAttributes.MaxRcvLinkSpeed = pVElan->pAdapt->BindParameters.MaxRcvLinkSpeed;
        GeneralAttributes.XmitLinkSpeed = pVElan->pAdapt->BindParameters.XmitLinkSpeed;
        GeneralAttributes.RcvLinkSpeed = pVElan->pAdapt->BindParameters.RcvLinkSpeed;
        ...
        //
        GeneralAttributes.MediaConnectState = pVElan->pAdapt->LastIndicatedLinkState.MediaConnectState;
        GeneralAttributes.MediaDuplexState = pVElan->pAdapt->LastIndicatedLinkState.MediaDuplexState;
        GeneralAttributes.XmitLinkSpeed = pVElan->pAdapt->LastIndicatedLinkState.XmitLinkSpeed;
        GeneralAttributes.RcvLinkSpeed = pVElan->pAdapt->LastIndicatedLinkState.RcvLinkSpeed;
        ...
        GeneralAttributes.LookaheadSize = pVElan->pAdapt->BindParameters.LookaheadSize;
        GeneralAttributes.MaxMulticastListSize = pVElan->pAdapt->BindParameters.MaxMulticastListSize;
        GeneralAttributes.MacAddressLength = pVElan->pAdapt->BindParameters.MacAddressLength;
        
        GeneralAttributes.PhysicalMediumType = pVElan->pAdapt->BindParameters.PhysicalMediumType ;
        GeneralAttributes.AccessType = pVElan->pAdapt->BindParameters.AccessType ; 
        GeneralAttributes.DirectionType = pVElan->pAdapt->BindParameters.DirectionType;         
        GeneralAttributes.ConnectionType = pVElan->pAdapt->BindParameters.ConnectionType ; 
        GeneralAttributes.IfType = pVElan->pAdapt->BindParameters.IfType ; 
        GeneralAttributes.IfConnectorPresent = FALSE; // RFC 2665 TRUE if physical adapter

        if (pVElan->pAdapt->BindParameters.RcvScaleCapabilities)
        {
            GeneralAttributes.RecvScaleCapabilities = pVElan->pAdapt->BindParameters.RcvScaleCapabilities;
        }
        else
        {
        ...
        GeneralAttributes.MacOptions = NDIS_MAC_OPTION_NO_LOOPBACK;
        ...
        GeneralAttributes.SupportedPacketFilters = pVElan->pAdapt->BindParameters.SupportedPacketFilters;
        ...
        GeneralAttributes.PowerManagementCapabilities = &pVElan->pAdapt->PowerManagementCapabilities;
        GeneralAttributes.SupportedOidList = VElanSupportedOids;
        GeneralAttributes.SupportedOidListLength = sizeof(VElanSupportedOids);
...
--*/
{
    ...
    DBGPRINT(MUX_LOUD, ("==> MPDevicePnPEvent: AdapterContext %08lx, DevicePnPEvent %x\n",MiniportAdapterContext, NetDevicePnPEvent->DevicePnPEvent));

...
#pragma prefast(suppress: __WARNING_BUFFER_OVERRUN_NONSTACK, "Buffer is (VELAN_MAX_MCAST_LIST * sizeof(MUX_MAC_ADDRESS)) bytes long")                           
...
MacAddrToString(PVOID In)
{
    ...
    {
#pragma prefast(suppress: __WARNING_POTENTIAL_BUFFER_OVERFLOW, "s is bounded by above check");    

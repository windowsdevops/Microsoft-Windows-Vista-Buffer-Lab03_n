...
StaFindBSSEntry(
    IN  PSTA_BSS_LIST           pBSSList,
    IN  const unsigned char *   srcAddress
    )
{
...
StaExpireBSSEntry(
    IN  PSTA_BSS_LIST           pBSSList,
    IN  ULONGLONG               ullMaxActiveTime,
    IN  ULONGLONG               ullExpireTimeStamp
    )
{
    PLIST_ENTRY         pHead = NULL, pEntry = NULL;
    PSTA_BSS_ENTRY      pBSSEntry = NULL;
...
StaGetEnumBSSIELength(
    IN PSTA_BSS_ENTRY       pStaBSSEntry
    )
{
...
StaMatchAPSSID(
    ...
    IN  PSTA_CURRENT_CONFIG             pConfig
    )
{

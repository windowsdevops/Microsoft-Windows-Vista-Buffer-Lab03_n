    ...
    )
{
    ...
    Hw11SetDevicePowerState(pAdapter->pNic, DevicePowerState);
}
    ...
    do
    {
        ...
        *pulBytesRead = sizeof(NDIS_DEVICE_POWER_STATE);
        ...
        if (NewDeviceState != NdisDeviceStateD0)
        {
            ...
            //
            Sta11PowerSleep(pAdapter->pStation, NewDeviceState);
        }
        ...
        if (NewDeviceState == NdisDeviceStateD0)
        {
            ...
            //
            Sta11PowerWakeup(pAdapter->pStation);
        }
    ...
    )
{
    ...
    *BytesNeeded = 0;
    ...
    Hw11QueryPnPCapabilities(pAdapter->pNic, (PNDIS_PNP_CAPABILITIES)InformationBuffer);

...
/** The List of Scatter Gather Elements of the packet described by MP_TX_MSDU */
#define     MP_TX_MSDU_SCATTER_GATHER_LIST(MpTxd)       (MpTxd)->SGList
...
#define     MP_TX_MSDU_HAS_SENDER               0x00000005
...
typedef struct _MP_TX_MSDU
{
    ...
    /** The number of outstanding Scatter gather operations */
    ...
    PVOID                       SGElementList[MP_802_11_MAX_FRAGMENTS_PER_MSDU];

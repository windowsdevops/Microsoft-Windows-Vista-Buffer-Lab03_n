    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QuerySupportedPHYTypes(pAdapter->pNic, uNumMaxEntries, pDot11SupportedPhyTypes);
    ...
    )
{
    ...
    if (MP_INCREMENT_RESET_PAUSE_COUNT(pAdapter) == 1)
    {
        ...
        //
        // For reset, wait for any scatter gather operations to
        // be completed before cleaning up pending sends
        //
    ...
    //
    Sta11ResetStep1(pAdapter->pStation, pDot11ResetRequest->dot11ResetType);
    ...
    //
    Sta11ResetStep4(pAdapter->pStation, pDot11ResetRequest->dot11ResetType);
    ...
    )
{
    ...
    MpTrace(COMP_OID, DBG_LOUD,  ("****  DOT11 RESET IN PROGRESS ****\n"));
    ...
    *BytesWritten = sizeof(DOT11_STATUS_INDICATION);
    ...
    if (MP_VERIFY_STATE(pAdapter, OP_STATE)) {
        ...
        if (pAdapter->Dot11RunningMode == RUNNING_MODE_STA_ADHOC) {
            Sta11DisconnectAdHoc(pAdapter->pStation);
        }
    }
...
MpSetMulticastList(
    ...
    IN OUT PULONG puBytesRead,
    IN OUT PULONG puBytesNeeded
    )
/*++
    ...
    )
{
    ...
    do
    {
        ...
        *BytesWritten = sizeof(ULONG);
        NdisMoveMemory(InformationBuffer, &pAdapter->uMPDUMaxLength, sizeof(ULONG));
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        Hw11QueryOpModeCap(pAdapter->pNic, pDot11OpModeCap);

        //
        // Please set the major and minor version appropriately
        // as defined by in hw_intf.h.
        //
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        Hw11QueryCurrentOperationMode(pAdapter->pNic, pCurrentOperationMode);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        uValue = Hw11QueryATIMWindow(pAdapter->pNic);
        NdisMoveMemory(
            InformationBuffer,
            &uValue,
            sizeof(ULONG)
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        value = Hw11QueryNicPowerState(pAdapter->pNic, TRUE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryOptionalCapability(pAdapter->pNic, pDot11OptionalCapability);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryCurrentOptionalCapability(pAdapter->pNic, pDot11CurrentOptionalCapability);
    ...
    )
{
    ...
    do
    {
        ...
        *((PBOOLEAN)InformationBuffer) = Hw11QueryCFPollable(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        ndisStatus = Hw11CanTransitionPower(pAdapter->pNic, DevicePowerState);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesWritten = sizeof(DOT11_RATE_SET);
        ...
        Hw11QueryOperationalRateSet(pAdapter->pNic, pDot11RateSet, TRUE);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryBeaconPeriod(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryRTSThreshold(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryShortRetryLimit(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryLongRetryLimit(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        uFragmentationThreshold = Hw11GetFragmentationThreshold(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryMaxReceiveLifeTime(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryMaxTXMSDULifeTime(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryCurrentRegDomain(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *pDot11TempType = Hw11QueryTempType(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryCurrentTXAntenna(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *pDot11DiversitySupport = Hw11QueryDiversitySupport(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryCurrentRXAntenna(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        Hw11QuerySupportedPowerLevels(pAdapter->pNic, pDot11SupportedPowerLevels);

        *BytesWritten = FIELD_OFFSET(DOT11_SUPPORTED_POWER_LEVELS, uNumOfSupportedPowerLevels) + 
            pDot11SupportedPowerLevels->uNumOfSupportedPowerLevels;
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *puValue = Hw11QueryCurrentTXPowerLevel(pAdapter->pNic);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11GetChannel(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryCCAModeSupported(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = (ULONG)Hw11QueryCurrentCCA(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryEdThreshold(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11GetOfdmFrequency(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11FrequencyBandsSupported(pAdapter->pNic, puValue, TRUE);
        *BytesWritten = sizeof(ULONG);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryRegDomainsSupportValue(pAdapter->pNic, uNumMaxEntries, pDot11RegDomainsSupportValue);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QuerySupportedTXAntenna(pAdapter->pNic, uNumMaxEntries, pDot11SupportedAntennaList);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QuerySupportedRXAntenna(pAdapter->pNic, uNumMaxEntries, pDot11SupportedAntennaList);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11QueryDiversitySelectionRX(pAdapter->pNic, uNumMaxEntries, pDot11DiversitySelectionRXList);
...
NDIS_STATUS
MpQueryInterruptModerationSettings(
    IN PADAPTER pAdapter,
    IN OUT PVOID InformationBuffer,
    IN ULONG InformationBufferLength,
    IN OUT PULONG BytesWritten,
...
{
    NDIS_STATUS ndisStatus = NDIS_STATUS_SUCCESS;
    PNDIS_INTERRUPT_MODERATION_PARAMETERS      pIntModParams;
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        pIntModParams = (PNDIS_INTERRUPT_MODERATION_PARAMETERS)InformationBuffer;        
        MP_ASSIGN_NDIS_OBJECT_HEADER(pIntModParams->Header, 
                                     NDIS_OBJECT_TYPE_DEFAULT,
                                     NDIS_INTERRUPT_MODERATION_PARAMETERS_REVISION_1,
                                     sizeof(NDIS_INTERRUPT_MODERATION_PARAMETERS));

        ndisStatus = Hw11QueryInterruptModerationSettings(
                        pAdapter->pNic, 
                        pIntModParams
                        );
...
NDIS_STATUS
MpSetInterruptModerationSettings(
    IN PADAPTER pAdapter,
    IN OUT PVOID InformationBuffer,
    IN ULONG InformationBufferLength,
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        if (!MP_VERIFY_NDIS_OBJECT_HEADER_DEFAULT(pIntModParams->Header, 
                                          NDIS_OBJECT_TYPE_DEFAULT,
                                          NDIS_INTERRUPT_MODERATION_PARAMETERS_REVISION_1,
                                          sizeof(NDIS_INTERRUPT_MODERATION_PARAMETERS)))
        {
        ...
        ndisStatus = Hw11SetInterruptModerationSettings(
                        pAdapter->pNic, 
                        pIntModParams
                        );
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11SetATIMWindow(pAdapter->pNic, uValue);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(ULONG);
        ...
        ndisStatus = Hw11SetNicPowerState(pAdapter->pNic, (BOOLEAN)uValue, TRUE);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        Hw11QueryStationId(pAdapter->pNic, InformationBuffer);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = dwRequiredSize;
        ...
        ndisStatus = Hw11SetOperationalRateSet(pAdapter->pNic, pDot11RateSet, TRUE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11SetBeaconPeriod(pAdapter->pNic, uValue);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11SetRTSThreshold(pAdapter->pNic, uValue);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11SetFragmentationThreshold(pAdapter->pNic, uValue);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        ndisStatus = Hw11SetCurrentRegDomain(pAdapter->pNic, uValue);
    ...
    )
{
    ...
    do
    {
	  ...
	  ndisStatus = Hw11SetChannel(pAdapter->pNic, (UCHAR)uValue, TRUE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(ULONG);
        ndisStatus = Hw11SetOfdmFrequency(pAdapter->pNic, *puValue, TRUE);        
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        {
            //
            // Another scan operation has already been received but not completed or 
            // we are in network monitoring mode
            //
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        // Pass to the station
        ndisStatus = Sta11QueryPrivacyExemptionList(pAdapter->pStation, list, InformationBufferLength);
    ...
    )
{
    ...
    *BytesNeeded = sizeof(BOOLEAN);
    ...
    ndisStatus = Sta11QueryHardwarePhyState(pAdapter->pStation, InformationBuffer);
    if (ndisStatus == NDIS_STATUS_SUCCESS)
    {
        *BytesWritten = sizeof(BOOLEAN);
    }
    ...
    )
{
    ...
    *BytesNeeded = sizeof(ULONG);
    ...
    ndisStatus = Sta11QueryCurrentPhyId(pAdapter->pStation, InformationBuffer);
    if (ndisStatus == NDIS_STATUS_SUCCESS)
    {
        *BytesWritten = sizeof(ULONG);
    }
    ...
    )
{
    ...
    *BytesNeeded = sizeof(BOOLEAN);
    ...
    ndisStatus = Sta11QueryMediaStreamingOption(pAdapter->pStation, InformationBuffer);
    if (ndisStatus == NDIS_STATUS_SUCCESS)
    {
        *BytesWritten = sizeof(BOOLEAN);
    }
    ...
    )
{
    ...
    *BytesNeeded = sizeof(ULONG);
    ...
    ndisStatus = Sta11QueryUnreachableDetectionThreshold(pAdapter->pStation, InformationBuffer);
    if (ndisStatus == NDIS_STATUS_SUCCESS)
    {
        *BytesWritten = sizeof(ULONG);
    }
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        // Pass to the station
        *BytesWritten = sizeof(ULONG);
        ndisStatus = Sta11QueryPowerMgmtRequest(pAdapter->pStation, (PULONG)InformationBuffer);
    }
    while (FALSE);
...
{
    return Sta11FlushBSSList(pAdapter->pStation);
}
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        // Pass to the station
        *BytesRead = sizeof(ULONG);
        ndisStatus = Sta11SetPowerMgmtRequest(pAdapter->pStation, *((PULONG)InformationBuffer));
    }
    while (FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = FIELD_OFFSET(DOT11_PRIVACY_EXEMPTION_LIST, PrivacyExemptionEntries) +
        ...
        // Pass to the station
        ndisStatus = Sta11SetPrivacyExemptionList(pAdapter->pStation, list, BytesRead);
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        if (pAdapter->Dot11RunningMode != RUNNING_MODE_STA_ADHOC) {
            ...
            //
            ndisStatus = Sta11ConnectInfra(pAdapter->pStation);
        ...
        if (pAdapter->Dot11RunningMode != RUNNING_MODE_STA_INFRASTRUCTURE) {
            ...
            // Pass the request to the station
            //
            ndisStatus = Sta11ConnectAdHoc(pAdapter->pStation);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesNeeded = 0;
        ...
        if (pAdapter->Dot11RunningMode == RUNNING_MODE_STA_INFRASTRUCTURE) {
            // Pass the request to the station
            ndisStatus = Sta11DisconnectInfra(pAdapter->pStation);
            
            pAdapter->State = INIT_STATE;
        }
        else {
            ndisStatus = Sta11DisconnectAdHoc(pAdapter->pStation);
            pAdapter->State = INIT_STATE;
        }
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(ULONG);
        ...
        ndisStatus = Sta11SetCurrentPhyId(pAdapter->pStation, PhyId);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(BOOLEAN);
        ...
        ndisStatus = Sta11SetMediaStreamingOption(pAdapter->pStation, bMediaStreamingEnabled);
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(ULONG);
        ndisStatus = Sta11SetUnreachableDetectionThreshold(pAdapter->pStation, *((PULONG)InformationBuffer));
    } while(FALSE);
    ...
    )
{
    ...
    do
    {
        ...
        *BytesRead = sizeof(BOOLEAN);
        ...
        if (ndisStatus == NDIS_STATUS_SUCCESS)
        {
            pAdapter->SafeModeEnabled = bSafeModeEnabled;
            MpAdjustReceiveHandler(pAdapter);
        }
    } while(FALSE);
...
//    MpEntry;
    ...
    *BytesNeeded = 0;
    ...
    case OID_DOT11_RF_USAGE:
        uInfo = Hw11QueryRFUsage(pAdapter->pNic);
    ...
    case OID_DOT11_SHORT_PREAMBLE_OPTION_IMPLEMENTED:
        ndisStatus = Hw11QueryShortPreambleOptionImplemented(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_PBCC_OPTION_IMPLEMENTED:
        ndisStatus = Hw11QueryPbccOptionImplemented(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_ERP_PBCC_OPTION_IMPLEMENTED:
        ndisStatus = Hw11QueryErpPbccOptionImplemented(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_ERP_PBCC_OPTION_ENABLED:
        ndisStatus = Hw11QueryErpPbccOptionEnabled(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_DSSS_OFDM_OPTION_IMPLEMENTED:
        ndisStatus = Hw11QueryDsssOfdmOptionImplemented(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;
		
    case OID_DOT11_DSSS_OFDM_OPTION_ENABLED:
        ndisStatus = Hw11QueryDsssOfdmOptionEnabled(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_SHORT_SLOT_TIME_OPTION_IMPLEMENTED:
        ndisStatus = Hw11QueryShortSlotTimeOptionImplemented(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;

    case OID_DOT11_SHORT_SLOT_TIME_OPTION_ENABLED:
        ndisStatus = Hw11QueryShortSlotTimeOptionEnabled(pAdapter->pNic, (PBOOLEAN)&uInfo, TRUE);
        uInfoLen = sizeof(BOOLEAN);
        break;        
    ...
    case OID_GEN_SUPPORTED_GUIDS:
        ...
        //
        ndisStatus = Hw11QuerySupportedGUIDS(pAdapter->pNic);
        break;
    ...
    case OID_GEN_LINK_SPEED:
        uInfo = (ULONG)(Hw11GetLinkSpeed(pAdapter->pNic) / 100);    // OID expects 100 bps
        uInfoLen = sizeof(uInfo);
        break;
    ...
    case OID_GEN_INTERRUPT_MODERATION:
        ndisStatus = MpQueryInterruptModerationSettings(
            pAdapter,
            InformationBuffer,
            InformationBufferLength,
            BytesWritten,
    ...
    {
        MpTrace(COMP_OID, DBG_SERIOUS,  ("MPQueryInformation completed! ADAPTER %p, OID 0x%08x, ndisStatus = 0x%08x\n",
                    pAdapter, Oid, ndisStatus));
    }
...
//    MpEntry;
    ...
    *BytesNeeded = 0;
    ...
    case OID_GEN_INTERRUPT_MODERATION:
        ndisStatus = MpSetInterruptModerationSettings(
            pAdapter,
            InformationBuffer,
            InformationBufferLength,
            BytesRead,
    ...
    if (ndisStatus != NDIS_STATUS_SUCCESS)
    {
        MpTrace(COMP_OID, DBG_SERIOUS,  ("SetInformation returned: 0x%08x\n", ndisStatus));
    }

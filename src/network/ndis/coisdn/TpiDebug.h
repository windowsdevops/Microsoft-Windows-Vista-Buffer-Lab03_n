...
extern VOID DbgPrintData(
    __in_bcount(NumBytes) IN unsigned char *    Data,
...
extern unsigned long __cdecl DbgPrint(__in __nullterminated PCCH Format, ...);
#endif
...
extern VOID DbgSilentQueue(__in_opt __nullterminated unsigned char * str);
...
#ifndef DBG_DEFAULTS
#   define DBG_DEFAULTS (DBG_ERROR_ON | DBG_WARNING_ON)
#endif

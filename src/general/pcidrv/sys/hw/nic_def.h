...
__inline VOID MP_STALL_EXECUTION(
   __in ULONG MsecDelay) //Eliyas UINT to ULONG
{
...
NICFillPoMgmtCaps (
    __in PFDO_DATA                 FdoData,
    __inout PNDIS_PNP_CAPABILITIES  pPower_Management_Capabilities,

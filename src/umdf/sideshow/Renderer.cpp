                                       ...
                                       const unsigned int wTextOffsetFromBottom)
{
    ...
    m_wszDefaultBackgroundTitle = new wchar_t[cchDefaultBackgroundTitle];
    ...
    m_wszDefaultBackgroundBody = new wchar_t[cchDefaultBackgroundBody];
    ...
    m_wszFontName = new wchar_t[cchFontName];
                                           ...
                                           CRenderedData* pRenderedData)
{
    ...
    pRenderedData->wszAlphanumericTitle = new wchar_t[SizeOfTitle];
    ...
    pRenderedData->wszAlphanumericBody = new wchar_t[SizeOfBody];
    ...
    if (0 < SizeOfBody) // Only try to display the body if it is greater than 0 characters
    {
        ...
        for (int nIndex = 0; nIndex < SizeOfBody; nIndex++) // nIndex is the current cursor position in the string
        {
    ...
    pRenderedData->pbBitmapData = new BYTE[pRenderedData->cbBitmapData];

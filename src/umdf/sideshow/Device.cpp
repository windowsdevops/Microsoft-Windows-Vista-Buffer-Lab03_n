                               ...
                               const DWORD dwDeviceBitDepth)
{
    ...
    m_wszDeviceFriendlyName = new wchar_t[cchDeviceFriendlyName];
    ...
    m_wszDeviceManufacturer = new wchar_t[cchDeviceManufacturer];
    ...
    m_wszDeviceFirmwareVersion = new wchar_t[cchDeviceFirmwareVersion];

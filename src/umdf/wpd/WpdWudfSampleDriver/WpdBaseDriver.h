...
public:
    ...
    HRESULT Initialize(LPCWSTR pszPortName, IPortableDeviceClassExtension* pPortableDeviceClassExtension);
    VOID    Uninitialize();
...
private:
    HRESULT OnSaveClientInfo(IPortableDeviceValues* pParams,
                             IPortableDeviceValues* pResults);

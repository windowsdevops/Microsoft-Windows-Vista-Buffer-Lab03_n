                                        ...
                                        IPortableDeviceValues*  pResults)
{
    ...
    if(hr == S_OK)
    {
        if(pObjectIDCollection != NULL)
        {
            ...
            hrTemp = pObjectIDCollection->GetCount(&ulCount);
...
HRESULT WpdObjectEnumerator::GetObjectIDs(
          ContextMap*                               pContextMap,
    const DWORD                                     dwNumObjects,
          LPCWSTR                                   pszEnumContext,
          IPortableDevicePropVariantCollection**    ppCollection)
{

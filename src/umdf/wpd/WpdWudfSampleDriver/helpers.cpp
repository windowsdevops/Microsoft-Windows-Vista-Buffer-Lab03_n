...
DECLARE_GUID(FakeContent_Format, 0x9b2dce3f, 0xcf02, 0x4643, 0xae, 0x09, 0x2b, 0xcf, 0x00, 0x12, 0xac, 0x6d);
// {8E829938-D838-479E-8489-5EC84986EE3B}
DECLARE_GUID(FakeDeviceContent_Format, 0x8E829938, 0xD838, 0x479E, 0x84, 0x89, 0x5E, 0xC8, 0x49, 0x86, 0xEE, 0x3B);
// {BDC7BBF8-3AAC-458F-92C9-7CD236186552}
DECLARE_GUID(FakeStorageContent_Format, 0xBDC7BBF8, 0x3AAC, 0x458F, 0x92, 0xC9, 0x7C, 0xD2, 0x36, 0x18, 0x65, 0x52);
...
KeyAndAttributesEntry g_FixedAttributesTable[] =
{
    ...
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_ID,                       UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_PERSISTENT_UNIQUE_ID,     UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_PARENT_ID,                UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_NAME,                     UnspecifiedForm_CanRead_CanWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_CONTENT_TYPE,             UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_FORMAT,                   UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_CAN_DELETE,               UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_ISHIDDEN,                 UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_ISSYSTEM,                 UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_NON_CONSUMABLE,           UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_MEDIA_HEIGHT,                    UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_MEDIA_WIDTH,                     UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_DATE_CREATED,             UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_ORIGINAL_FILE_NAME,       UnspecifiedForm_CanRead_CanWrite_CannotDelete_Fast},
    {&WPD_OBJECT_FORMAT_JFIF, &WPD_OBJECT_SIZE,                     UnspecifiedForm_CanRead_CannotWrite_CannotDelete_Fast},
...
HRESULT AddPropertyKeyArrayToCollection(
    const PROPERTYKEY**             ppKeys,
    const DWORD                     cKeys,
    IPortableDeviceKeyCollection*   pCollection)
{
    ...
    IPortableDeviceValues*           pAttributes)
{
    ...
    // Adjust the attributes for the specific proeprty type if needed
    ...
    IPortableDeviceKeyCollection*  pKeys)
{
    ...
    else if (guidObjectFormatOrCategory  == WPD_OBJECT_FORMAT_JFIF)
    {
...
HRESULT GetAtlStringValue(PROPERTYKEY Key, IPortableDeviceValues* pValues, CAtlStringW& strValue)
{
    HRESULT hr       = S_OK;
...
HRESULT CreateVCard(IPortableDeviceValues* pValues, CAtlStringA& strVCard)
{
    ...
    if (pValues != NULL)
    {
        ...
        hrTemp = GetAtlStringValue(WPD_CONTACT_LAST_NAME, pValues, strLastName);                         // WPD_CONTACT_LAST_NAME
        hrTemp = GetAtlStringValue(WPD_CONTACT_FIRST_NAME, pValues, strFirstName);                       // WPD_CONTACT_FIRST_NAME
        hrTemp = GetAtlStringValue(WPD_CONTACT_DISPLAY_NAME, pValues, strDisplayName);                   // WPD_CONTACT_DISPLAY_NAME
        hrTemp = GetAtlStringValue(WPD_CONTACT_COMPANY_NAME, pValues, strCompanyName);                   // WPD_CONTACT_COMPANY_NAME
        hrTemp = GetAtlStringValue(WPD_CONTACT_ROLE, pValues, strRole);                                  // WPD_CONTACT_ROLE
        hrTemp = GetAtlStringValue(WPD_CONTACT_PRIMARY_PHONE, pValues, strPrimaryPhoneNumber);           // WPD_CONTACT_PRIMARY_PHONE or WPD_CONTACT_PERSONAL_PHONE
        hrTemp = GetAtlStringValue(WPD_CONTACT_BUSINESS_PHONE, pValues, strBusinessPhoneNumber);         // WPD_CONTACT_BUSINESS_PHONE
        hrTemp = GetAtlStringValue(WPD_CONTACT_MOBILE_PHONE, pValues, strMobilePhoneNumber);             // WPD_CONTACT_MOBILE_PHONE
        hrTemp = GetAtlStringValue(WPD_CONTACT_PRIMARY_FAX, pValues, strPrimaryFaxPhoneNumber);          // WPD_CONTACT_PRIMARY_FAX
        hrTemp = GetAtlStringValue(WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE1, pValues, strAddressLine1); // WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE1
        hrTemp = GetAtlStringValue(WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE2, pValues, strAddressLine2); // WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_LINE2
        hrTemp = GetAtlStringValue(WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_CITY, pValues, strAddressCity);   // WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_CITY
        hrTemp = GetAtlStringValue(WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_POSTAL_CODE, pValues, strAddressPostalCode); // WPD_CONTACT_PERSONAL_POSTAL_ADDRESS_POSTAL_CODE
    }

    // Create the VCARD from the properties found in the IPortableDeviceValues
    strVCard.Format(VCARD_FORMAT,strLastName, strFirstName,
                                 strDisplayName,
                                 strCompanyName,
                                 strRole,
                                 ...
                                 strPrimaryFaxPhoneNumber,
                                 strAddressLine1, strAddressLine2, strAddressCity, strAddressPostalCode);
    return hr;
}

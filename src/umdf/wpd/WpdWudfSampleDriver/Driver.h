...
class ATL_NO_VTABLE CDriver :
    ...
    public CComCoClass<CDriver, &CLSID_WpdWudfSampleDriver>,
    public IDriverEntry,
...
public:
    ...
    DECLARE_REGISTRY_RESOURCEID(IDR_WpdWudfSampleDriver)
...
OBJECT_ENTRY_AUTO(__uuidof(WpdWudfSampleDriver), CDriver)

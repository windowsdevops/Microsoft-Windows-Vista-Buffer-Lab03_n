    ...
    )
{
    ...
    ServerEaList = RxAllocatePoolWithTag ( PagedPool, EA_QUERY_SIZE, MRXSMB_MISC_POOLTAG );
    if ( ServerEaList == NULL ) {
...

{
   ...
   smbSrvOpen = MRxSmbGetSrvOpenExtension(capFobx->pSrvOpen);
    ...
    Buffer = RxAllocatePoolWithTag ( PagedPool, OutDataCount, MRXSMB_MISC_POOLTAG );
    ...
    if ( UserEaList != NULL) {
        ...
        ServerQueryEaList = RxAllocatePoolWithTag ( PagedPool, UserEaListLength, MRXSMB_MISC_POOLTAG );

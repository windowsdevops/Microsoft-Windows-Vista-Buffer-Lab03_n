        ...
        if ((pSessionEntry == NULL) && (Status == STATUS_SUCCESS)) {
            ...
            if (Status != STATUS_SUCCESS) {
                ...
                if (pPassword != NULL) {
                    ...
                    RtlZeroMemory( pPassword->Buffer, pPassword->MaximumLength );
...
--*/
{
    ...
    if (pSessionEntry->Session.pPassword != NULL) {
        ...
        RtlZeroMemory( pSessionEntry->Session.pPassword->Buffer, 
                       pSessionEntry->Session.pPassword->MaximumLength );

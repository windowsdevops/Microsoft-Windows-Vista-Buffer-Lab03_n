...
--*/
{
    ...
    ExInitializeResourceLite( &UnavailableServerListResource );
...
--*/
{
    ...
    ExDeleteResourceLite( &UnavailableServerListResource );
...
--*/
{
    ...
    ExAcquireResourceExclusiveLite( &UnavailableServerListResource, TRUE );
    ...
    ExReleaseResourceLite( &UnavailableServerListResource );

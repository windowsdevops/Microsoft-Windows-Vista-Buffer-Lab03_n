...
DRIVER_DISPATCH PscrPnP;

DRIVER_DISPATCH PscrPower;
...
IO_COMPLETION_ROUTINE PscrPcmciaCallComplete;

IO_COMPLETION_ROUTINE PscrDevicePowerCompletion;
...
DRIVER_ADD_DEVICE PscrAddDevice;
...
DRIVER_UNLOAD PscrUnloadDriver;
...
DRIVER_CANCEL PscrCancel;

DRIVER_DISPATCH PscrCleanup;

KSERVICE_ROUTINE PscrIrqServiceRoutine;
...
DRIVER_DISPATCH PscrCreateClose;

DRIVER_DISPATCH PscrSystemControl;

DRIVER_DISPATCH PscrDeviceIoControl;

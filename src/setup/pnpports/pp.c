    ...
    )
{
    ...
    //
    StringCchCopy(Params->pAdvancedData->szNewComName, ARRAYSIZE(Params->pAdvancedData->szNewComName), Params->PortSettings.szComName);
    ...
    if (DisplayAdvancedDialog(DialogHwnd, Params->pAdvancedData)) {
        ...
        if (_tcscmp(Params->pAdvancedData->szNewComName,
            ...
            StringCchCopy(Params->PortSettings.szComName, ARRAYSIZE(Params->PortSettings.szComName), Params->pAdvancedData->szNewComName);
        }
    }
}
    ...
    )
{
    ...
    StringCchCat(szBuild, ARRAYSIZE(szBuild), m_pszParitySuf[i]);
    ...
    StringCchCat(szBuild, ARRAYSIZE(szBuild), m_pszLenSuf[i]);
    ...
    StringCchCat(szBuild, ARRAYSIZE(szBuild), m_pszStopSuf[i]);
    ...
    StringCchCat(szBuild, ARRAYSIZE(szBuild), m_pszFlowSuf[i]);

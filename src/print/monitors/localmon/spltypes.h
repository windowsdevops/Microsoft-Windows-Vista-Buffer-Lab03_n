...
typedef __struct_bcount(cb) struct _INIPORT {       /* ipo */
    DWORD   signature;
    DWORD   cb;
    __field_ecount_opt(1) struct  _INIPORT *pNext;
    DWORD   cRef;
    LPWSTR  pName;
...
typedef __struct_bcount(cb) struct _INIXCVPORT {
    DWORD       signature;
    DWORD       cb;
    __field_ecount_opt(1) struct      _INIXCVPORT *pNext;
    DWORD       cRef;
    DWORD       dwMethod;
    LPWSTR      pszName;
    DWORD       dwState;

...
void TokenFromParamValueFromNumberFF
   (__in ParseVarsType *pParseVars, ParamType);
void SetNewList(__in ParseVarsType *pParseVars,
   ParamType);
void GetTotalAndLargestFF(__in ParseVarsType *pParseVars,ParamType param);
void GetCodeAndOnlineFF(__in ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexSetNewList(__in ParseVarsType *pParseVars,ParamType param);
void SetValueFromParamFF(__in ParseVarsType *pParseVars,ParamType param);
void SetValueFromParam(__in ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromNumberEOLFromParam(__in ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromBooleanEOL(__in ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromStringEOL(__in ParseVarsType *pParseVars,ParamType param);


/* Fuctions called when no string in a keywords list is found */
void ActionNotFoundSkipPastFF(__in ParseVarsType *pParseVars);
void ActionNotFoundSkipCFLFandIndentedLines(__in ParseVarsType *pParseVars);


/* Helper Functions */
void StoreToken(__in ParseVarsType *pParseVars, DWORD dwToken);
BOOL StoreTokenValueAndAdvancePointer
   (__in ParseVarsType *pParseVars, UINT_PTR dwValue);
void  ExpectFinalCRLFFF(__in ParseVarsType *pParseVars);
BOOL  SkipPastNextCRLF(__in ParseVarsType *pParseVars);
int GetPositiveInteger(__in ParseVarsType *pParseVars);
BOOL AdvancePointerPastString
   (__in ParseVarsType *pParseVars, __in LPSTR pString);
BOOL SkipOverSpaces(__in ParseVarsType *pParseVars);
int LookForKeyword(__in ParseVarsType *pParseVars);
BOOL ExpectString(__in ParseVarsType *pParseVars, __in LPSTR pString);
BOOL SkipPastFF(__in ParseVarsType *pParseVars);
void ExpectFinalFF(__in ParseVarsType *pParseVars);
...
DWORD GetPJLTokens(
    ...
    __out_ecount(nTokenInBuffer) TokenPairType *pToken,
    __out   DWORD *pnTokenParsed,
    __out   LPSTR *plpInPJL
)
{
   ...
   DBG_MSG(DBG_TRACE, ("ParseVars.status = %d\n", parseVars.status));
...
*/
BOOL AdvancePointerPastString(__in  ParseVarsType *pParseVars, __in LPSTR pString)
{
...
void SetNewList(__in ParseVarsType *pParseVars, ParamType param)
{
...
BOOL StoreTokenValueAndAdvancePointer(__in ParseVarsType *pParseVars, UINT_PTR dwValue)
{
...
void ActionNotFoundSkipCFLFandIndentedLines(__in ParseVarsType *pParseVars)
{
   DBG_MSG(DBG_TRACE, ("ActionNotFoundSkipCRLF In=%hs\n", pParseVars->pInPJL_Local));
   ...
   do
      ...
      if ( !SkipPastNextCRLF(pParseVars) )
         ...
         DBG_MSG(DBG_TRACE, ("ActionNotFoundSkipCRLF error skipping\n"));

         return;
         }
      } while (*pParseVars->pInPJL_Local==TAB);

   DBG_MSG(DBG_TRACE, ("ActionNotFoundSkipCRLF Out=%hs\n", pParseVars->pInPJL_Local));

   return;
}

void GetTokenFromIndexValueFromNumberEOLFromParam
   (__in ParseVarsType *pParseVars,ParamType param)
{
   int value;

   param; /* to eliminate not used warning */

   DBG_MSG(DBG_TRACE, ("GetTokenFromIndexValueFromNumberIn=%hs\n", pParseVars->pInPJL_Local));
   ...
   if ( (value=GetPositiveInteger(pParseVars))==-1 )
      ...
      DBG_MSG(DBG_TRACE, ("error getting number\n"));
   ...
   if ( !StoreTokenValueAndAdvancePointer(pParseVars, value) )
      ...
      DBG_MSG(DBG_TRACE, ("error storing value\n"));
   ...
   DBG_MSG(DBG_TRACE, ("GetTokenFromIndexValueFromNumberOut=%hs\n", pParseVars->pInPJL_Local));
   ...
   (__in ParseVarsType *pParseVars,ParamType param)
{
   ...
   DBG_MSG(DBG_TRACE, ("GetTokenFromIndexValueFromBooleanEOLin=%hs\n", pParseVars->pInPJL_Local));

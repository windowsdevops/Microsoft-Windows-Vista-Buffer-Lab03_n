...

{
   ...
   //
   // In fact, 'pDevExt' will never be NULL here.
   //
   __assume(pDevExt != NULL);
...
#pragma prefast(suppress: 28159, "Legacy API dependency")
...
SerialReadSymName(IN PSERIAL_DEVICE_EXTENSION PDevExt, IN HANDLE hRegKey,
                  OUT PUNICODE_STRING PSymName,
                  __deref_out_opt PWCHAR *PpRegName)
{
   NTSTATUS status;

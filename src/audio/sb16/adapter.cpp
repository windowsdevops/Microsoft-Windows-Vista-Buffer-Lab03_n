...
(
    ...
    __in_opt    PFNCREATEINSTANCE   MiniportCreate      OPTIONAL,
    __in_opt    PUNKNOWN            UnknownAdapter      OPTIONAL,
    __in_opt    PRESOURCELIST       ResourceList,
    __in        REFGUID             PortInterfaceId,
    __out_opt   PUNKNOWN *          OutPortInterface    OPTIONAL,
    __out_opt   PUNKNOWN *          OutPortUnknown      OPTIONAL
)
{
    PAGED_CODE();

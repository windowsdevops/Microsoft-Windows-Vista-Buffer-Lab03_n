...
public:
    ...
    STDMETHODIMP OnDefaultDeviceChanged(EDataFlow flow, ERole role, LPCWSTR pwstrDefaultDeviceId) { return S_OK; }
    ...
    STDMETHODIMP GetFormatRepresentation(UINT nFormat, __deref_out LPWSTR* ppwstrFormatRep);

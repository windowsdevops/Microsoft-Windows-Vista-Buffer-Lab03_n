...
typedef struct _ASYNC_READ {
    ...
    __bound ULONG           nNumberOfBytesToRead;
    ULONG           nBlockSize;
    ULONG           fulFlags;
    ULONG           ulGeneration;
    UCHAR           Data[1];
...
typedef struct _ASYNC_WRITE {
    ...
    ULONG           bGetGeneration;
    IO_ADDRESS      DestinationAddress;
    __bound ULONG           nNumberOfBytesToWrite;
    ULONG           nBlockSize;
    ULONG           fulFlags;
    ULONG           ulGeneration;
    UCHAR           Data[1];
...
typedef struct _ASYNC_STREAM {
    __bound ULONG           nNumberOfBytesToStream;
    ULONG           fulFlags;
    ULONG           ulTag;
    ULONG           nChannel;
    ULONG           ulSynch;
...
typedef struct _ISOCH_ATTACH_BUFFERS {
    HANDLE                  hResource;
    __bound ULONG                   nNumberOfDescriptors;
    ULONG                   ulBufferSize;

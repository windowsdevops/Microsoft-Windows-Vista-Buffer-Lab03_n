    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            for (i=0;i<DeviceData.numDevices;i++) {
                ...
                StringCbCopyN (tmpBuff, (sizeof(tmpBuff)), DeviceData.deviceList[i].DeviceName, 255);
                tmpBuff[255] = '\0';
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            for (i=0;i<VirtDeviceData.numDevices;i++) {
                ...
                StringCbCopyN (tmpBuff, ( sizeof(tmpBuff) ), VirtDeviceData.deviceList[i].DeviceName, 255);
                tmpBuff[255] = '\0';
                SendMessage(hWndListBox, LB_ADDSTRING, 0, (LPARAM)tmpBuff);

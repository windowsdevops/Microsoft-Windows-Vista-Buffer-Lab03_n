    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochAttachBuffers->hResource);
    ...
    )
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochDetachBuffers->hResource);
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochDetachBuffers->pIsochDescriptor);

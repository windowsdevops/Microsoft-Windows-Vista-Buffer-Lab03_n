...

{
    ...
    if (CallNumber == 2) {
        ...
        __analysis_assume((sizeof(MODE_MEDIUM_PART_PAGE) - 2) == Srb->DataTransferLength);
        //
...

{
    ...
    if (CallNumber == 2) {
        ...
        __analysis_assume(EXABYTE_MODE_LENGTH == Srb->DataTransferLength);
...

{
    ...
    if (CallNumber == 1) {
        ...
        __analysis_assume((sizeof(MODE_DEVICE_CONFIG_PAGE) - 1) == Srb->DataTransferLength);

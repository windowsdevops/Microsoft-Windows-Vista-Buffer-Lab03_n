...
#include "debug.tmh"
        ...
        if ((DebugPrintLevel <= (ClassDebug & 0x0000ffff)) ||
            ...
            if (ClasspnpGlobals.UseBufferedDebugPrint &&
                ...
                if (ClasspnpGlobals.Buffer == NULL) {
                    ...
                    SIZE_T bufferSize;
                    RtlSIZETMult(ClasspnpGlobals.NumberOfBuffers,  ClasspnpGlobals.EachBufferSize, &bufferSize);
            ...
            if (ClasspnpGlobals.UseBufferedDebugPrint &&
                ...
                status = RtlStringCchVPrintfA(buffer, ClasspnpGlobals.EachBufferSize, DebugMessage, ap);
    ...
    )
    {
        ...
        //
        Index = InterlockedIncrement( &DiskSpinupIndex );

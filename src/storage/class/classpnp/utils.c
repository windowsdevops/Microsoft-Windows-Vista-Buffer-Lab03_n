...
BOOLEAN ClasspMyStringMatches(__in_opt IN PCHAR StringToMatch OPTIONAL, __in IN PCHAR TargetString);
    ...
    )
{
    ...
    RtlULongAdd(descHeader->Size, deviceIdDescriptor->Size, &descHeader->Size);
    ...
    )
{
    ...
    RtlULongAdd(descHeader->Size, deviceDescriptor->Size, &descHeader->Size);

...
DRIVER_UNLOAD IsoUsb_DriverUnload;
DRIVER_ADD_DEVICE IsoUsb_AddDevice;
...
--*/
{
    ...
    // Initialize the configuration change semaphore
    //
    KeInitializeSemaphore(&deviceExtension->ConfigurationSemaphore, 1, 1);

...
--*/
{
    ...
    if(NT_SUCCESS(ntStatus) &&
       PendingStop == deviceExtension->DeviceState) {
    ...
    //
    // Complete the IRP that was pended by our completion rotuine
    //
    Irp->IoStatus.Status = ntStatus;
    Irp->IoStatus.Information = 0;
    ...
    *Descriptor = ExAllocatePool(NonPagedPool,
    ...
    if (*Descriptor != NULL)
    {
        ...
        else
        {
            ...
            *Descriptor = NULL;     // added by grapeky
...
--*/
{
    ...
    memset( interfaceInfoList, 0, numInterfaces*sizeof(PUSBD_INTERFACE_INFORMATION) );
...
--*/
{
    ...
    PUSBD_INTERFACE_INFORMATION     interfaceInfoCopy = NULL;
    ULONG                           i;
    ULONG                           j;
    NTSTATUS                        ntStatus;
...
--*/
{
    ...
    memset( &busInterfaceVer1, 0, sizeof(USB_BUS_INTERFACE_USBDI_V1) );
